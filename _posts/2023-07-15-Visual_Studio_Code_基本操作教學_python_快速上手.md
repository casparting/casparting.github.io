...
1. 你已經有別人提供的程式碼或是已經確認耀基於別人某個程式碼繼續開發的，[請參考這開啟別人的專案或程式碼](./2023-07-15-Visual_Studio_Code_基本操作教學_python_快速上手.md#開啟別人的專案或程式碼)。

2. 你是新手想自己新增一個新檔案來撰寫python檔案做練習，[請參考這新增一個新檔案並建立虛擬環境](./2023-07-15-Visual_Studio_Code_基本操作教學_python_快速上手.md#新增一個新檔案並建立虛擬環境)。
